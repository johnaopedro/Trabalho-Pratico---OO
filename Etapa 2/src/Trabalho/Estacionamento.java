...
public class Estacionamento {
	...
	public Estacionamento(int NumerodeAcessos, int capacidade, float Lucro, float ValorDoContratante, int HoraAberturaHora, int HoraAberturaMinuto, int HoraAberturaSaidaHora, int HoraAberturaSaidaMinuto, int TempoTotalEstacionamentoHora, int TempoTotalEstacionamentoMinuto, String Horario) {
	...
	public Estacionamento(int numeroEstacionamento, int vagas, int horarioFunHora, int horarioFunMinuto,
			int horarioNotHora, int horarioNotMinuto) {
